...
class SpeakerStatistics(BaseModel):
    ...
    most_active_meeting: str | None = None  # 가장 활발했던 회의 task_id
...
class SpeakerParticipationResponse(BaseModel):
    ...
    highest_participation_meeting: str | None = None  # 가장 높은 참여도 회의
    lowest_participation_meeting: str | None = None  # 가장 낮은 참여도 회의
