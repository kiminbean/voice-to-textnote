...
from backend.db.models import Bookmark
...
class TestEnhancedBookmarkAPI:
    ...
    async def test_bookmark_search_request_validation(self):
        ...
        assert len(validated_tags) == 2  # 중복 제거됨
    ...
    async def test_bookmark_cleanup_request_validation(self):
        ...
        # 날짜 유효성 검증
        cleanup_request.older_than_days = 400  # 최대 365일 초과
        assert cleanup_request.older_than_days == 365  # 자동 조정
