...
from backend.app.error_handlers import VoiceNoteError
from backend.app.main import app
from backend.app.middleware.audit_log import AuditLogMiddleware, API_ACCESS_COUNTER
...
async def test_voice_note_error_handler_none_domain_exc():
    ...
    """
    from backend.app.error_handlers import _voicenote_error_handler, VoiceNoteError
