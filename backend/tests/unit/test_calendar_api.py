...
async def test_create_calendar_event_success(client):
    ...
    meeting_data = {
        "segments": [
            {"start": 0, "end": 60, "speaker": "김민준", "text": "안녕하세요, 오늘 회의 시작합니다."},
            {"start": 60, "end": 120, "speaker": "이지아", "text": "이번 분기 목표에 대해 논의해봅시다."},
            {"start": 120, "end": 180, "speaker": "김민준", "text": "액션 아이템: 리포트 작성하기 (할 일)"},
        ],
        "duration": 180,
    }
