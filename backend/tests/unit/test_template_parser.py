...
def sample_pdf_path(tmp_path: Path) -> Path:
    ...
    try:
        ...
        try:
            ...
            pdf.cell(200, 10, "Meeting Minutes", new_x="LMARGIN", new_y="NEXT")
            pdf.cell(200, 10, "1. Overview", new_x="LMARGIN", new_y="NEXT")
            pdf.cell(200, 10, "Date: 2025-01-01", new_x="LMARGIN", new_y="NEXT")
            pdf.cell(200, 10, "2. Main Agenda", new_x="LMARGIN", new_y="NEXT")
