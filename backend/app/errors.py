...
def request_entity_too_large(msg: str = "요청 크기가 허용 한도를 초과했습니다", **kwargs: str) -> NoReturn:
    """
...
def service_unavailable(msg: str = "서비스를 일시적으로 사용할 수 없습니다", **kwargs: str) -> NoReturn:
    """
