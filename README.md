...
**마지막 업데이트**: 2026-06-17
**버전**: 1.7.0
**상태**: Phase 8 진행 중 — SPEC-OBSIDIAN-001 Obsidian Vault 연계 완료, 감정/톤 분석 활성화, 라이선스 All Rights Reserved 전환
**최근 확인**: SPEC-RELEASE-001 완료 — Release Readiness 실행 절차 문서화 (4단계 가이드, CHANGELOG v1.6.0). 3374 백엔드 테스트 + 328 Flutter 테스트 전부 통과. Strict release readiness는 외부 계정/물리 기기 설정 후 통과 가능.
