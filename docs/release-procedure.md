...
- [x] 백엔드: 3967 passed, Flutter: 415 passed, backend coverage 100.00%
...
| 2.3 E2E | `FIREBASE_TEST_DEVICE_TOKEN`, `RELEASE_E2E_EVIDENCE_PATH` | repo 내부 evidence JSON 17개 required scenario `pass:true` + `platforms` 계약 일치 + scenario별 device id + 중복 없는 screenshot/log/video/trace/attachment 관측 산출물 단서와 파일명/URL/`artifact:`/`attachment:` 식별자 |
