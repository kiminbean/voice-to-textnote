...
| Contact manager for sales notes | Sales follow-up summary mode and Sales Contact Brief API implemented | Full CRM/contact list UI and business-card scanning remain | P3 |
