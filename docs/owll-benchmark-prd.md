...
| Contact manager for sales notes | Sales follow-up summary mode, Sales Contact Brief API, Result-screen tab, searchable/cross-meeting discoverable sales brief artifacts, backend customer list API, and Flutter lifecycle filters implemented | Rich CRM editing and business-card scanning remain | P3 |
