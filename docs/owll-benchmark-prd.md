...
| OCR for PDFs/images | PDF/DOCX/image document import API, Flutter Home entry point, and Android native share-sheet file/image ingestion implemented for searchable note context, with optional image OCR runtime support | iOS share extension ingestion remains | P2 |
