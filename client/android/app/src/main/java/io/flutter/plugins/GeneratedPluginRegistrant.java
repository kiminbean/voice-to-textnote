...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new nl.silversoft.audio_decoder.AudioDecoderPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin audio_decoder, nl.silversoft.audio_decoder.AudioDecoderPlugin", e);
    }
    try {
