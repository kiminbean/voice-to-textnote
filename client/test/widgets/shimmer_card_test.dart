...
void main() {
  group('ShimmerCard', () {
    // 렌더링 테스트
    testWidgets('ShimmerCard가 오류 없이 렌더링되어야 함',
    ...
    // Shimmer 효과 포함 테스트
    testWidgets('Shimmer 애니메이션 위젯이 포함되어야 함',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
  ...
  group('ShimmerText', () {
    // 렌더링 테스트
    testWidgets('ShimmerText가 오류 없이 렌더링되어야 함',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
    ...
    // 라인 수 파라미터 테스트
    testWidgets('lines 파라미터에 따라 여러 줄이 렌더링되어야 함',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
